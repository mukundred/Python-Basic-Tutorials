## Sttring In Python
print("'Hey', he said, while watching The Godfather")
print("The Monologue was : ")
Monologue = '''Mr. Trask: I'm going to recommend to the disciplinary committee that you be expelled, Mr. Sims. You are a cover-up artist and you are a liar.
